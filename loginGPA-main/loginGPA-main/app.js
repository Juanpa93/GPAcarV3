...
document.addEventListener("DOMContentLoaded", function () {
  ...
  did("btn_continuar").addEventListener("click", function () {
    ...
    fetch("http://127.0.0.1:8081/validacion", requestOptions)
      ...
      .then((result) => {
        ...
        if (result.includes("no existe")) {
          ...
          fetch("http://127.0.0.1:8081/registro", requestOptions)
            .then((response) => response.text())
            .then((result) => {
              console.log(result)
    ...
    fetch("http://127.0.0.1:8081/validacion", requestOptions)
      ...
      .then((result) => {
        ...
        if (!result.includes("no existe")) {
          ...
          fetch("http://127.0.0.1:8081/iniciar", requestOptions)
            .then((response) => response.text())
            .then((result) => {
              console.log(result)
              if (result.includes("0")) {
                ...
                url = "http://127.0.0.1:5500/home.html?par1="+parametro1
