...
document.addEventListener("DOMContentLoaded", function () {
    ...
    did("btn_confirmar_orden").addEventListener("click", function(){
        ...
        reservas.forEach(element => {
            ...
            fetch("http://127.0.0.1:8081/ordenes", requestOptions)
    ...
    did("cont_etiqueta_principal_ordenes").addEventListener("click", function(){
        ...
        const requestOptions = {
          ...
          fetch("http://127.0.0.1:8081/listarordenes/" + user.documento, requestOptions)
            .then((response) => response.text())
            .then((result) => {
...
fetch("http://127.0.0.1:8081/actualizar/"+id, requestOptions)
  .then((response) => response.text())
  .then((result) => {
...
function cargarVehiculos(){
    const requestOptions = {
      ...
      fetch("http://127.0.0.1:8081/listarcarros", requestOptions)
        .then((response) => response.text())
        .then((result) => {
            console.log(JSON.parse(result))
...
function solinfouser(cor, con){
   ...
   setTimeout(function(){
    const requestOptions = {
      ...
      fetch("http://127.0.0.1:8081/infouser/"+cor, requestOptions)
        .then((response) => response.text())
        .then((result) => {
            console.log(result)
